...
# with command line options: Configuration/GenProduction/python/SUS-RunIIFall17FSPremix-00069-fragment.py --filein file:fullsim_step3_output.root --fileout file:fullsim_miniAOD.root --mc --eventcontent MINIAODSIM --datatier MINIAODSIM --conditions 94X_mc2017_realistic_v15 --step PAT --scenario pp --era Run2_2017,run2_miniAOD_94XFall17 --python_filename fullsim_step4_cfg.py --runUnscheduled --no_exec
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:fullsim_step3_output.root'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:fullsim_miniAOD.root'),
