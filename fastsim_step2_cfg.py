...
# with command line options: Configuration/GenProduction/python/SUS-RunIIFall17FSPremix-00069-fragment.py --filein file:fastsim_step1_output.root --fileout file:fastsim_miniAOD.root --mc --eventcontent MINIAODSIM --runUnscheduled --fast --datatier MINIAODSIM --conditions 94X_mc2017_realistic_v15 --step PAT --scenario pp --era Run2_2017_FastSim,run2_miniAOD_94XFall17 --python_filename fastsim_step2_cfg.py --no_exec
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:fastsim_step1_output.root'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:fastsim_miniAOD.root'),
