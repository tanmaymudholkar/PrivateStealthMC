...
# with command line options: Configuration/GenProduction/python/SUS-RunIIFall17FSPremix-00069-fragment.py --fileout file:fullsim_step1_output.root --mc --eventcontent RAWSIM --datatier GEN-SIM --conditions 94X_mc2017_realistic_v15 --beamspot Realistic25ns13TeVEarly2017Collision --customise_commands process.source.numberEventsInLuminosityBlock = cms.untracked.uint32(200) --step GEN,SIM --era Run2_2017 --python_filename fullsim_step1_cfg.py --no_exec
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:fullsim_step1_output.root'),
...
process.generator = cms.EDFilter("Pythia8GeneratorFilter",
    RandomizedParameters = cms.VPSet( (cms.PSet(
            ConfigDescription = cms.string('T5WgStealth_1600_800'),
            ConfigWeight = cms.double(150.0),
            GridpackPath = cms.string('/cvmfs/cms.cern.ch/phys_generator/gridpacks/2017/13TeV/madgraph/V5_2.4.2/sus_sms/LO_PDF/SMS-GlGl/v1/SMS-GlGl_mGl-1600_slc6_amd64_gcc481_CMSSW_7_1_30_tarball.tar.xz'),
